import {
    ...
    InputNumber, Radio, Row, Select, SelectProps, Skeleton, TimePicker, Upload
} from "antd";
...
export interface IAutoForm {
    ...
    type?: 'input' | 'textarea' | 'password' | 'checkbox' |
...
export function AutoForm({
    ...
    function getInput(props: IAutoForm) {
        ...
        if (loading) {
            return <Skeleton.Input active block={props.skeletonBlock} className={props.skeletonClassName}
